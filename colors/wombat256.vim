...
" Modified:     Larissa Reis
" Last Change:  May 23 2019
"
" wombat256.vim - a modified version of Wombat originally modified by Lars
" Nielsen that also works on xterms with 88 or 256 colors. The algorithm for
" approximating the GUI colors with the xterm palette is from desert256.vim by
" Henry So Jr.
...
call <SID>X("Question",     "027b02",         "",   "bold")
            "CursorIM
            "IncSearch
call <SID>X("Search",       "cccccc",   "5A647E",       "")
...
call <SID>X("CursorLineNr", "ffed75",   "121212",   "none")
...
call <SID>X("Delimiter",    "519F50",         "",   "none")
